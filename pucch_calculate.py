...
import math
N_CCE=45 #看rantcp RRC setup //frequencyDomainResources: fffffffffff8 [bit length 45
R_PUCCH=14 #看rantcp RRC setup, Reconfiguration // PUCCH-ResourceSet resourceList: 14 items

delta_PRI=7 #看bbuiolog DCI1_1
n_cce=36 #看bbuiolog DCI1_1
